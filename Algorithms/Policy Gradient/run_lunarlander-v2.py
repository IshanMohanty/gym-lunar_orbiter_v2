...
if __name__ == '__main__':
    ...
    f = open(TRAINING_LOG_DIR + 'episode_reward_log@April_30_21dian.txt', 'w')
    ...
    for episode in range(EPISODES):
        ...
        while True:
            ...
            if done:
                ...
                # save data
                f = open(TRAINING_LOG_DIR + 'episode_reward_log@April_30_21dian.txt', 'a')
